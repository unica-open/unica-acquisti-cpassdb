...
FROM (values
	('AAAAAA00A11B000J', '21', 'Demo', '000 0000000', false),
...
update cpass.cpass_t_parametro set valore = @Value@ where chiave = 'MIT_CLIENT_ID';
update cpass.cpass_t_parametro set valore = @Value@ where chiave = 'MIT_CLIENT_KEY';
update cpass.cpass_t_parametro set valore = @Value@ where chiave = 'MIT_USERNAME';
update cpass.cpass_t_parametro set valore = @Value@ where chiave = 'MIT_PASSWORD';
