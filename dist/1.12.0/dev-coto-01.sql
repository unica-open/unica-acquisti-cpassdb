...
FROM ( VALUES
    ...
    ,('IMPLEMENTOR_POJO_NAME', @value@,'IMPEGNO', 'SICRAWEB', 'Per interrogazione IMPEGNO', true,'COTO')
...
update cpass.cpass_t_parametro set valore = 'http://coll-stilo.wsbe.cittametropolitana.torino.it/stilobusiness/soap/WSTrovaDocFolder?wsdl' where chiave = 'WSDL_LOCATION_RICERCA_DOC' and riferimento = 'PROVVEDIMENTO';
update cpass.cpass_t_parametro set valore = 'http://coll-stilo.wsbe.cittametropolitana.torino.it/stilobusiness/soap/WSGetMetadataUd?wsdl' where chiave = 'WSDL_LOCATION' and riferimento = 'PROVVEDIMENTO';
update cpass.cpass_t_parametro set valore = 'SINCRONA', ente_id = (select ente_id from cpass_t_ente cte where cte .ente_codice = 'COTO') where chiave = 'MODALITA_INVIO_EVASIONE' and riferimento = 'EVASIONE';
