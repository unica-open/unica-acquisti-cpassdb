...
update cpass_d_ord_tipo_procedura set ente_id = (select ente_id from cpass_t_ente where ente_codice = 'COTO');
...
FROM (VALUES
	('INT_TIPO_PROCEDURA',true, true, true, true,'','COTO'),
	('INT_ACQ_AGGIUNTO_O_VARIATO',true, true, true, true,'obbligatorieta'' subordinata al permesso SVINCOLA_INT_ACQ_AGGIUNTO_O_VARIATO','COTO')
