...
-- =========================LICENSE_END==================================
---
update cpass_d_ord_tipo_procedura set ente_id = (select ente_id from cpass_t_ente where ente_codice = 'REGP');
...
FROM (VALUES
	('INT_TIPO_PROCEDURA',false, false, false, false,'','REGP'),
	('INT_ACQ_AGGIUNTO_O_VARIATO',true, true, true, true,'obbligatorieta'' subordinata al permesso SVINCOLA_INT_ACQ_AGGIUNTO_O_VARIATO','REGP')
