...
FROM ( VALUES
	('ALGORITMO_CONFRONTO_PER_DIREZIONE', 'true','PROVVEDIMENTO', 'STILO', 'decide l''algoritmo di confronto tra settore emittente e settore della struttura proponente', true,'REGP')
