...
FROM (VALUES
  ('LOGIN_INVIO_CONTABILITA', 'APPJ', true, '', 'SIAC', 'login per xml incio in contabilità ','CMTO')
...
UPDATE cpass_d_oggetti_spesa SET ENTE_ID = '0ced449c-a147-5419-802f-01acfab32807';
