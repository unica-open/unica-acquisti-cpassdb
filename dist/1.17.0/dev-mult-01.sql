...
FROM (VALUES
  ('LOGIN_INVIO_CONTABILITA', 'APPJ', true, '', 'SIAC', 'login per xml incio in contabilità ','CSI')
...
UPDATE cpass_d_oggetti_spesa SET ENTE_ID = '3ddfa599-8ede-514c-ac46-34c9ef033620';
