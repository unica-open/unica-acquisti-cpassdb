...
FROM (VALUES
  ('LOGIN_INVIO_CONTABILITA', 'APPJ', true, '', 'SIAC', 'login per xml incio in contabilità ','REGP')
...
UPDATE cpass_d_oggetti_spesa SET ENTE_ID = 'dc661167-9239-59c7-952c-dba431e87548';
