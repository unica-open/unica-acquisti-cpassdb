...
FROM (VALUES
  ('LOGIN_INVIO_CONTABILITA', 'APPJ', true, '', 'SICRAWEB', 'login per xml incio in contabilità ','COTO')
...
UPDATE cpass_d_oggetti_spesa SET ENTE_ID = '25b3cb3e-0c7e-53b2-88bd-afc47011647d';
ALTER TABLE cpass.cpass_d_oggetti_spesa  ALTER COLUMN ente_id SET NOT NULL;
--"32936085-3fc2-52df-8f1d-36c40fe398b2"