...
FROM (VALUES
  ('AVVIO_CON_ANNO_MAGGIORE', 'false', true, 'PBA', 'CPASS', 'Parametro controllato nella carica acquisti precedenti , in caso di avvio di un CUI con anno maggiore del primo anno di destinazione','REGP')
