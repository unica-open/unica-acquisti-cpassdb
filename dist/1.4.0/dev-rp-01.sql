...
FROM (VALUES
  ('UTENTE_BATCH', 'AAAAAA00A11B000J', true, 'BATCH', 'BATCH', 'utenza identificata come batch','REGP')
...
FROM (VALUES
   ('REGP','REGP','VERIFICA_INVIO_CONTABILITA',TRUE,'batch verifica invio contabilita')
  ,('REGP','REGP','AGGIORNAMENTO_IMPEGNI',TRUE,'batch aggiornamento impegni')
  ,('REGP','REGP','DDT',TRUE,'batch documento di trasporto')
  ,('REGP','REGP','RECUPERO_NOTIFICA_NSO',TRUE,'batch notifica nso')
  ,('REGP','REGP','SMISTATORE',TRUE,'batch smistatore rms')
