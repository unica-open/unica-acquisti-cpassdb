...
-- carico RUOLI/MODULI per ente CRP
INSERT INTO cpass_r_ruolo_modulo (ruolo_id, modulo_id, ente_id)
SELECT dr.ruolo_id, dm.modulo_id, te.ente_id 
FROM (VALUES
('BO','SMISTATORE_RMS','CRP'),
('ORD','CHIUSURA_ORDINI','CRP'),
('ORD','TRASM_NSO','CRP'),
('ORD','ORDINSEMPLICE','CRP'),
('ORD','ORDINATORE','CRP'),
('ORD','INTERRORD','CRP'),
('ORD','ADMIN','CRP'),
('PBA','ADMIN','CRP'),
('PBA','RUO','CRP'),
('PBA','DELEGATO_REFP','CRP'),
('PBA','COMPILATORE','CRP'),
('PBA','RUP','CRP'),
('PBA','DELEGATO_RUP','CRP'),
('PBA','REFP','CRP'),
('PBA','OSS','CRP'),
('RMS','VALIDATORE_RMS','CRP'),
('RMS','RICHIEDENTE_RMS','CRP'),
('RMS','ADMIN','CRP')
) AS tmp( modulo, ruolo, ente)
