...
FROM (VALUES
      ('REGP','REGP','AGG_STRUTTURA',FALSE,'batch aggiornamento struttura organizzativa')
...
FROM ( VALUES
    ('NUMERAZIONE_ATTI_UNIVOCA', 'false', 'IMPEGNO', 'SIAC', 'Per interrogazione IMPEGNO', true,'REGP')
