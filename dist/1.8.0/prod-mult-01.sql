...
FROM (VALUES
  ('CONGRUENZA_BENI_IMPEGNI', 'true', false, '', 'CPASS', 'indica se il sistema deve verificare la congruenza dati nell''ordine tra ods e finanziario associato','CSI')
...
update cpass_t_fornitore set ente_id = (select ente_id from cpass_t_ente where ente_codice = 'CRP');
