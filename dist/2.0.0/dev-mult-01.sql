...
FROM (VALUES
   ('report.endpoint'      , 'http://10.138.198.16:10310/cpassrepeng/report', true, '', 'CPASS', 'ricerca soggetto fonte esterna ','CSI')
  ,('report.multi.endpoint', 'http://10.138.198.16:10310/cpassrepeng/multi-report', true, '', 'CPASS', 'ricerca soggetto fonte esterna ','CSI') 
