...
FROM (VALUES
   ('report.endpoint', 'http://10.138.157.34:10410/cpassrepeng/report', true, '', 'CPASS', 'ricerca soggetto fonte esterna ','CMTO')
  ,('report.multi.endpoint', 'http://10.138.157.34:10410/cpassrepeng/multi-report', true, '', 'CPASS', 'ricerca soggetto fonte esterna ','CMTO') 
