...
FROM (VALUES
   ('report.endpoint', 'http://10.138.157.32:10210/cpassrepeng/report', true, '', 'CPASS', 'ricerca soggetto fonte esterna ','COTO')
  ,('report.multi.endpoint', 'http://10.138.157.32:10210/cpassrepeng/multi-report', true, '', 'CPASS', 'ricerca soggetto fonte esterna ','COTO') 
