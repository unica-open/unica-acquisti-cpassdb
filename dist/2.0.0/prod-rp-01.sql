...
FROM (VALUES
   ('report.endpoint',       'http://10.138.157.37:10110/cpassrepeng/report', true, '', 'CPASS', 'ricerca soggetto fonte esterna ','REGP')
  ,('report.multi.endpoint', 'http://10.138.157.37:10110/cpassrepeng/multi-report', true, '', 'CPASS', 'ricerca soggetto fonte esterna ','REGP') 
