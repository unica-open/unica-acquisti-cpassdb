...
---
-- TEST-CMTO-01
delete from cpass.cpass_t_parametro where chiave in ('report.endpoint','report.multi.endpoint');
...
FROM (VALUES
   ('report.endpoint',       'http://10.138.167.136:10810/cpassrepeng/report', true, '', 'CPASS', 'ricerca soggetto fonte esterna ','CMTO')
  ,('report.multi.endpoint', 'http://10.138.167.136:10810/cpassrepeng/multi-report', true, '', 'CPASS', 'ricerca soggetto fonte esterna ','CMTO') 
