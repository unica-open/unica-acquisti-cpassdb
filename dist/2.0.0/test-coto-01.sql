...
FROM (VALUES
   ('report.endpoint',       'http://10.138.167.130:10610/cpassrepeng/report', true, '', 'CPASS', 'ricerca soggetto fonte esterna ','COTO')
  ,('report.multi.endpoint', 'http://10.138.167.130:10610/cpassrepeng/multi-report', true, '', 'CPASS', 'ricerca soggetto fonte esterna ','COTO') 
