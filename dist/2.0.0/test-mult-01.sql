...
FROM (VALUES
   ('report.endpoint', 'http://10.138.167.141:10710/cpassrepeng/report', true, '', 'CPASS', 'ricerca soggetto fonte esterna ','CSI')
  ,('report.multi.endpoint', 'http://10.138.167.141:10710/cpassrepeng/multi-report', true, '', 'CPASS', 'ricerca soggetto fonte esterna ','CSI') 
