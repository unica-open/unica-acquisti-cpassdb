...
FROM (VALUES
   ('report.endpoint', 'http://10.138.167.117:10510/cpassrepeng/report', true, '', 'CPASS', 'ricerca soggetto fonte esterna ','REGP')
  ,('report.multi.endpoint', 'http://10.138.167.117:10510/cpassrepeng/multi-report', true, '', 'CPASS', 'ricerca soggetto fonte esterna ','REGP') 
