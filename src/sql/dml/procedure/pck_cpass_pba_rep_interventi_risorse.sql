...
SELECT      int_1.intervento_id, programma_1.programma_id,
            intimp.intervento_importi_importo_anno_primo AS importo_anno_primo,
            intimp.intervento_importi_importo_anno_secondo AS importo_anno_secondo,
            intimp.intervento_importi_importo_anni_successivi AS
...
--GROUP BY int_1.intervento_id, programma_1.programma_id
    ...
    SELECT int_1.intervento_id, 
           programma_1.programma_id,
           risorsa.risorsa_descrizione as risorsa,
    ...
    SELECT 
        ...
        ,importi_cap_privati.risorsa
        ,'CAPITALE PRIVATO'::character varying AS tipologia        
    FROM cpass_t_pba_intervento "int"
       JOIN cpass_d_stato stato ON "int".stato_id = stato.stato_id and stato.stato_tipo = 'INTERVENTO' 
